...
RUN [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; `
    Invoke-WebRequest $env:MINGW_W64_X86 -OutFile "C:\Windows\Temp\mingw-w64-x86.7z"; `
...
RUN [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; `
    Invoke-WebRequest $env:MINGW_W64_X64 -OutFile "C:\Windows\Temp\mingw-w64-x64.7z"; `
